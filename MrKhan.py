...
|____| \|____|'|____|/\|____|‘'|____|/\|____|° |____| '\|____ | 
  ───────────────────────────────────────────────────────× 
   ───────────────────────────────────────────────────────× 
 \t\033[1;97m[\x1b[1;97m\x1b[1;41m Khan\x1b[0m\x1b[1;97m] 
 \t\033[1;97m[\x1b[1;97m\x1b[1;41m Version 1 :5\x1b[0m\x1b[1;97m] \033[1;37m  
  ───────────────────────────────────────────────────────× 
  """) 
 def logo2(): 
|¯¯¯¯| '/¯¯¯¯/'|¯¯¯¯| '|¯¯¯¯|° /¯¯¯¯/\¯¯¯¯\‚  |¯¯¯¯¯\  |¯¯¯¯|'
...
|____| \|____|'|____|/\|____|‘'|____|/\|____|° |____| '\|____ | 
 ...
 def helpnote(): 
         ...
         subprocess.check_output(["am", "start", "https://github.com/Mr Khan/run.txt/blob/main/run.txt"]) 
...
|____| \|____|'|____|/\|____|‘'|____|/\|____|° |____| '\|____ | 
 ...
 ───────────────────────────────────────────────────────×  
     """) 
                 ...
                 khan = input("    \033[0;97m(=×>)\033[0;97m CHOOSE : ") 
                 print("───────────────────────────────────────────────────────× ") 
                 if tanya in ["", " "]: 
                         Main() 
                 elif tanya in ["1", "01"]: 
 ...
 'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36', 
  ...
  'Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-G977N/KSU4CTG1) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/12.1 Chrome/79.0.3945.136 Mobile Safari/537.36' 
   ...
   'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0' 
    ...
    # 'cookie': 'datr=JMD2ZIYL0M9OvVxeVrZXeE0Q; sb=JMD2ZA53BEpSYkIJkfoBLeds; m_pixel_ratio=2; wd=360x666; fr=04oFWUIUWcHyypN2w..Bk9sAk.ko.AAA.0.0.Bk9sAo.AWXY-OjmPFo',
    'dpr': '2',
  ...
  #Khan copy krke apna name dal dyna 
